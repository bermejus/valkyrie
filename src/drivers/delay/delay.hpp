...
#define cpu_delay_ms(x) portable_delay_cycles(cpu_ms_2_cy(x, sysclk_get_cpu_hz()))
#define cpu_delay_us(x) portable_delay_cycles(cpu_us_2_cy(x, sysclk_get_cpu_hz()))
#define cpu_delay_ns(x) portable_delay_cycles(cpu_ns_2_cy(x, sysclk_get_cpu_hz()))
