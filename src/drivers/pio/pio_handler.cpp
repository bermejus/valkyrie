...
static s_interrupt_source gs_interrupt_sources[MAX_INTERRUPT_SOURCES];
...
/*
    * Set an interrupt handler for the specified pin.
    * The provided handler will be called with the triggering pin as its parameter
    * as soon as an interrupt is detected.
    *
...
/*
 * Parallel IO Controller A interrupt handler.
...
/*
 * Parallel IO Controller B interrupt handler
...
/*
 * Parallel IO Controller D interrupt handler.
